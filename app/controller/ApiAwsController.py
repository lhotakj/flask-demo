...
class ApiAwsController:
    ...
    def cloud_watch_tags(self, tags):
        return make_response(jsonify(
            {
                "data": [
                    {
                        ...
                        "memory": [12, 6, 3, 6, 10, 16, 20, 22, 23, 50, 55, 20, 21, 23, 18, 87, 80, 21, 93, 18, 17, 16,
                                   15, 13, 12],
                        "cpu": [90, 20, 50, 1, 98, 99, 96, 99, 99, 99, 100, 96, 99, 99, 99, 100, 96, 99, 99, 99, 100,
                                100, 100, 99, 98],
                        "swap": [21, 20, 10, 1, 20, 18, 13, 12, 15, 16, 19, 20, 19, 20, 23, 22, 13, 12, 15, 26, 19, 19,
                                 16, 20, 20]
                    }
                ]
            }
